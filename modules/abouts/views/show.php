<h1><?= $headline ?> <span class="smaller hide-sm">(<?= $about_title ?> Record ID: <?= $update_id ?>)</span></h1>
<?= flashdata() ?>
<div class="card">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="record-details">
                ...
                <div class="row">
                    <div>About Sub Title</div>
                    <div><?= $about_sub_title ?></div>
                </div>
                <div class="row">
                    <div class="full-width">
                        <div><b>About Text</b></div>
                        <div><?= nl2br($about_text) ?></div>
                    </div>
                </div>
            </div>
        </div>
