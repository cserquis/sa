<h1><?= $headline ?> <span class="smaller hide-sm">(<?= $link_name ?> ID: <?= $update_id ?>)</span></h1>
<?= flashdata() ?>
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('homepage_pictures/manage', 'View All Homepage Pictures', array("class" => "button alt"));
        echo anchor('homepage_pictures/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('homepage_pictures/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Homepage Picture record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
