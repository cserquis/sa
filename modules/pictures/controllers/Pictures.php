...
class Pictures extends Trongate {
    ...
    function order_pictures() {
        ...
        $data['target_directory'] = BASE_URL.'pictures/'.$target_module.'_pictures_thumb/'.$target_module_id.'/';

        $data['upload_url'] = BASE_URL.'my_filezone/uploader/'.$target_module.'/'.$target_module_id;
