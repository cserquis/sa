<h1><?= $headline ?> <span class="smaller hide-sm">(<?= $published_date ?> ID: <?= $update_id ?>)</span></h1>
<?= flashdata() ?>
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('publications/manage', 'View All Publications', array("class" => "button alt"));
        echo anchor('publications/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
        ...
        <div class="card-body">
            <div class="record-details">
                <div class="row">
                    ...
                    <div><?= $publication_title ?></div>
                </div>
                <div class="row">
                    <div>Publication Media</div>
                    <div><?= $publication_media ?></div>
                </div>
                <div class="row">
                    <div>Media Link</div>
                    <div><?= $media_link ?></div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('publications/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Publication record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
