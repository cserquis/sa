<h1><?= $headline ?> <span class="smaller hide-sm">(<?= $tag_name ?> -  ID: <?= $update_id ?>)</span></h1>
<?= flashdata() ?>
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('tags/manage', 'View All Tags', array("class" => "button alt"));
        echo anchor('tags/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('tags/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Tag record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
