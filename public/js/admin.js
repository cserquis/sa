...
function drawAssociatedRecords(relationName, results) {
    ...
    for (var i = 0; i < results.length; i++) {
        ...
        newTd.setAttribute("class", "fosimax");
        ...
        disBtn.innerHTML = '<i class="fa fa-ban" style="margin: 0;"></i> ';
...
if (typeof drawComments == 'boolean') {
    ...
    function refreshPictures(pictures) {
        ...
        if (pics.length < 1) {
            ...
            var targetDirectory = baseUrl + 'pictures/' + segment1 + '_pictures/' + updateId + '/';
